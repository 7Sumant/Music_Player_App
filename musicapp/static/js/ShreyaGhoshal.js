...
left_scrolls.addEventListener('click', ()=>{
    ...
    const songs = [
    {
        ...
        poster: 'static/img/ShreyaGhoshal/1.jpg',
        playCount: 0  
    },
    {
        id: '2',
        songName: `Bahara <br>
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/2.jpg',
        playCount: 0  
    },
    {
        id: '3',
        ...
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/3.jpg',
        playCount: 0  
    },
    {
        id: '4',
        ...
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/4.jpg',
        playCount: 0  
    },
    {
        id: '5',
        songName: `Rasiya <br>
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/5.jpg',
        playCount: 0 
    },
    {
        id: '6',
        songName: `Saibo <br>
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/6.jpg',
        playCount: 0  
    },
    {
        id: '7',
        ...
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/7.jpg',
        playCount: 0
    },
    {
        id: '8',
        songName: `Raabta <br>
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/8.jpg',
        playCount: 0
    },
    {
        id: '9',
        ...
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/9.jpg',
        playCount: 0
    },
    {
        id: '10',
        ...
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/10.jpg',
        playCount: 0
    },
    {
        id: '11',
        songName: `Manwa Laage <br>
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/11.jpg',
        playCount: 0
    },
    {
        id: '12',
        songName: `Pal Pal Har Pal <br>
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/12.jpg',
        playCount: 0
    },
    {
        id: '13',
        ...
        <div class="subtitle">Shreya Ghoshal</div>`,
        poster: 'static/img/ShreyaGhoshal/13.jpg',
        playCount: 0
    },
    {
        id: '14',
...
let music = new Audio('static/audio/ShreyaGhoshal/${index}.mp3');
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((element)=>{
    element.addEventListener('click',(e)=>{
        ...
        music.src = `static/audio/ShreyaGhoshal/${index}.mp3`;
        poster_master_play.src = `static/img/ShreyaGhoshal/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play-circle');
        masterPlay.classList.add('bi-pause-circle');
        download_music.href = `static/audio/ShreyaGhoshal/${index}.mp3`;
