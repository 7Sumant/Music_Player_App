...
const songs = [
    {
        ...
        poster: 'static/img/ar/1.jpg',
        playCount: 0
    },
    {
        id: '2',
        songName: `Raanjhanaa <br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/2.jpg',
        playCount: 0
    },
    {
        id: '3',
        songName: `Radha Kaise na Jale <br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/3.jpg',
        playCount: 0
    },
    {
        id: '4',
        songName: `Tum Tak <br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/4.jpg',
        playCount: 0
    },
    {
        id: '5',
        songName: `Yeh Jo Des Hai Tera<br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/5.jpg',
        playCount: 0
    },
    {
        id: '6',
        songName: `Jashn-E-Bahaaraa<br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/6.jpg',
        playCount: 0
    },
    {
        id: '7',
        songName: `Jiya Jale <br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/7.jpg',
        playCount: 0
    },
    {
        id: '8',
    ...
    },
    {
        ...
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/9.jpg',
        playCount: 0
    },
    {
        id: '10',
        songName: `Ay Hairathe<br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/10.jpg',
        playCount: 0
    },
    {
        id: '11',
    ...
    },
    {
        ...
        songName: `Tu hai<br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/12.jpg',
        playCount: 0
    },
    {
        id: '13',
        songName: `Maahi Ve <br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/13.jpg',
        playCount: 0
    },
    {
        id: '14',
        songName: `Dam Tara <br>
        <div class="subtitle">A. R. Rahman</div>`,
        poster: 'static/img/ar/14.jpg',
        playCount: 0
    },
    {
        id: '15',
...
let music = new Audio('static/audio/ar/1.mp3');
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((element)=>{
    element.addEventListener('click',(e)=>{
        ...
        music.src = `static/audio/ar/${index}.mp3`;
        poster_master_play.src = `static/img/ar/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play-circle');
        masterPlay.classList.add('bi-pause-circle');
        download_music.href = `static/audio/ar/${index}.mp3`;
