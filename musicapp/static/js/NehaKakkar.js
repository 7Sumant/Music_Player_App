...
const songs = [
    {
        ...
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/1.jpg',
        playCount: 0
    },
    {
        id: '2',
        songName: `DILBAR <br>
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/2.jpg',
        playCount: 0
    },
    {
        id: '3',
        ...
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/3.jpeg',
        playCount: 0
    },
    {
        id: '4',
        ...
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/4.jpg',
        playCount: 0
    },
    {
        id: '5',
        ...
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/5.jpg',
        playCount: 0
    },
    {
        id: '6',
        songName: `Queen_ London Thumakda <br>
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/6.jpg',
        playCount: 0
    },
    {
        id: '7',
        ...
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/7.jpg',
        playCount: 0
    },
    {
        id: '8',
        songName: `Buhe Vich <br>
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/8.jpg',
        playCount: 0
    },
    {
        id: '9',
        ...
        poster: 'static/img/NehaKakkar/9.jpg',
        playCount: 0
    },
    {
        id: '10',
        songName: `Garmi <br>
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/10.jpg',
        playCount: 0
    },
    {
        id: '11',
        ...
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/11.jpg',
        playCount: 0
    },
    {
        id: '12',
        songName: `Nikle Currant <br>
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/12.jpg',
        playCount: 0
    },
    {
        id: '13',
        songName: `PUCHDA HI NAHIN <br>
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/13.jpg',
        playCount: 0
    },
    {
        id: '14',
        ...
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/14.jpg',
        playCount: 0
    },
    {
        id: '15',
        songName: `Savan Aya Hai <br>
        <div class="subtitle">NehaKakkar</div>`,
        poster: 'static/img/NehaKakkar/15.jpg',
        playCount: 0
    },
    {
        id: '100',
        songName: 'Kesariya <br><div class="subtitle">Arijit Singh</div>',
        poster: 'static/img/100.jpg',
        playCount: 0
    },
    {
        id: '101',
        songName: 'Pehle Bhi Main <br><div class="subtitle">A. R. Rahman</div>',
        poster: 'static/img/101.jpg',
        playCount: 0
    },
    {
        id: '102',
        songName: 'Raataan Lambiyan <br><div class="subtitle">Jubin Nautiyal</div>',
        poster: 'static/img/102.jpg',
        playCount: 0
    },
    {
        id: '103',
        songName: 'O Maahi <br><div class="subtitle">Arijit Singh</div>',
        poster: 'static/img/103.jpg',
        playCount: 0
    },
    {
        id: '104',
        songName: 'Gulabi Sadi <br><div class="subtitle">Sanju Rathod</div>',
        poster: 'static/img/104.jpg',
        playCount: 0
    },
    {
        id: '105',
        songName: 'Husn <br><div class="subtitle">Anuv Jain</div>',
        poster: 'static/img/105.jpg',
        playCount: 0
    },
    {
        id: '106',
        songName: 'Rang Sari <br><div class="subtitle">Guru Randhawa</div>',
        poster: 'static/img/106.jpg',
        playCount: 0
    }
];
...
let music = new Audio('static/audio/NehaKakkar/1.mp3');
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((element)=>{
    element.addEventListener('click',(e)=>{
        ...
        music.src = `static/audio/NehaKakkar/${index}.mp3`;
        poster_master_play.src = `static/img/NehaKakkar/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play-circle');
        masterPlay.classList.add('bi-pause-circle');
        download_music.href = `static/audio/NehaKakkar/${index}.mp3`;
